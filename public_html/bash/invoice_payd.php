...
$DolartoBtc =  currency('BTC', 'USD', 1); // 1 bitcoin convertido para Dolar
$BtctoDolar =  currency('USD', 'BTC'); // valor do dólar
            ...
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                        <?php
                        $sql = $pdo->pdo->query("SELECT * FROM invoice_upgrade  as i INNER JOIN usuarios as u on i.personal_id=u.id WHERE  i.status='Payd'");
                        if($sql->rowCount()>0){
                            ...
                            foreach($res as $row) {
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td> <?php echo $BtctoDolar*$row->price_up?> BTC</td>
                                    <td class="center"><?php echo $row->date?></td>
                                    <td class="center"><b><?php echo $row->wallet?></b></td>

                                    <td class="center">
                                        <a  <button class="btn btn-success">PAYD</button>
