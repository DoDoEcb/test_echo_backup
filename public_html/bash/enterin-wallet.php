...
$linkSeis = ""; $linkSete = ""; $linkOito = "active"; $linkNove = ""; $linkDez = ""; $linkOnze = "";
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
            ...
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                        <?php
                    $sql = $pdo->pdo->query("SELECT *,u.name as name_user FROM usuarios as u INNER JOIN plan as p INNER JOIN withdraw as w ON u.id=w.personal_id ");
                        if($sql->rowCount()>0) {
