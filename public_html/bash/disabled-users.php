...
require_once("logicas.php");
    ...
    $linkUm = ""; $linkDois = ""; $linkTres = "active"; $linkQuatro = ""; $linkCinco = "";
                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <?php
                                $sql = $pdo->pdo->query("SELECT * FROM usuarios as u INNER JOIN  financeiro as f INNER JOIN  renovacao as r  on u.id=f.personal_id AND r.personal_id=u.id WHERE f.status!='Ativo'");
                                if($sql->rowCount()>0){
                                    ...
                                    foreach($res as $row){
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td style="color: orange">Renovar</td>
                                            ...
                                            <td class="center">
                                                <a href="profile?active_user=<?php echo $row->username?>"> <button class="btn btn-info">Ativar</button></a>
                                                <a href="profile?block_user=<?php echo $row->username?>"> <button class="btn btn-default">Bloquear</button></a>
                                                <a href="profile?del_user=<?php echo $row->username?>&username=<?php echo $row->username?>"><button class="btn btn-warning">Excluir</button></a>
                                            </td>
                                        </tr>
                                    <?php
