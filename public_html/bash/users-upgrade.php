                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <?php
                                $sql = $pdo->pdo->query("SELECT * FROM invoice_upgrade  as i INNER JOIN usuarios as u on i.personal_id=u.id WHERE i.descricao LIKE '%Upgrade%'");
                                if($sql->rowCount()>0){
