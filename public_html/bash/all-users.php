...
$busca =   $_POST['search'];
                                  $sql = $pdo->pdo->query("SELECT * FROM usuarios as u INNER JOIN  financeiro as f INNER JOIN  renovacao as r  on u.id=f.personal_id AND r.personal_id=u.id WHERE u.username LIKE '%$busca%' ");

                                }else {
                                  $sql = $pdo->pdo->query("SELECT * FROM usuarios as u INNER JOIN  financeiro as f INNER JOIN  renovacao as r  on u.id=f.personal_id AND r.personal_id=u.id limit 250 ");
                              }
                                    ...
                                    foreach($res as $row){
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">
                                                ...
                                                <a href="profile?block_user=<?php echo $row->username?>"> <button class="btn btn-default">Bloquear</button></a>
                                                <a href="profile?del_user=<?php echo $row->username?>"><button class="btn btn-warning">Excluir</button></a>
                                                <a href="profile?qualifi=<?php echo $row->username?>"><button class="btn btn-success">Qualificar</button></a>
                                                <a href="profile?desqualifi=<?php echo $row->username?>"><button class="btn btn-danger">Desqualificar</button></a>
                                            </td>
                                        </tr>
                                    <?php
